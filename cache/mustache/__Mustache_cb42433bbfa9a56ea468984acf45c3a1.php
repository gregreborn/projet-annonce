...
class __Mustache_cb42433bbfa9a56ea468984acf45c3a1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '  <!-- 2) Votre CSS personnalisé (facultatif) -->
';
        $buffer .= $indent . '  <link rel="stylesheet" href="';
        $value = $this->resolveValue($context->find('PUBLIC_ABSOLUTE_PATH'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '      <!-- Insertion du menu (entete.mustache) -->
';
