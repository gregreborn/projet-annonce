...
class __Mustache_b69b9ae6b8d9a7e97c7937eda1e02d8a extends Mustache_Template
{
...
';
        $buffer .= $indent . '        const phoneVal = input.value.trim();
';
        $buffer .= $indent . '        if (phoneVal !== "") {
';
...
';
        $buffer .= $indent . '        }
';
        $buffer .= $indent . '        // Si le champ est vide, on ne fait rien et on laisse passer le formulaire.
';
        $buffer .= $indent . '      });
';
        $buffer .= $indent . '    });
...
';
        $buffer .= $indent . '<script>
';
        $buffer .= $indent . '    function togglePhoneExample() {
';
        $buffer .= $indent . '      var exampleBox = document.getElementById("phone-example");
';
        $buffer .= $indent . '      if (exampleBox.style.display === "none" || exampleBox.style.display === "") {
';
        $buffer .= $indent . '        exampleBox.style.display = "block";
';
        $buffer .= $indent . '      } else {
';
        $buffer .= $indent . '        exampleBox.style.display = "none";
';
        $buffer .= $indent . '      }
';
        $buffer .= $indent . '    }
