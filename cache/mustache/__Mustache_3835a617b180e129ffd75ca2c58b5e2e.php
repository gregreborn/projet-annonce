...
class __Mustache_3835a617b180e129ffd75ca2c58b5e2e extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '  <!-- 1) Charger Foundation en premier -->
';
...
';
        $buffer .= $indent . '  <!-- 2) Votre CSS personnalisé après (si nécessaire) -->
';
        $buffer .= $indent . '  <link rel="stylesheet" href="';
        $value = $this->resolveValue($context->find('PUBLIC_ABSOLUTE_PATH'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '  <!-- Autres librairies CSS (ex: intl-tel-input) -->
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '  <!-- Scripts PristineJS etc. -->
';
...
';
        $buffer .= $indent . '<body>
';
        $buffer .= $indent . '  <!-- Off-canvas wrapper global -->
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '      <!-- Insertion de l\'en-tête (menu latéral + barre mobile) -->
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '  <!-- Initialisation de Foundation -->
';
