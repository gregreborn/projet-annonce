...
class __Mustache_af5d8166a02b628e8c72faadc0fff78d extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '  <!-- 2) Votre CSS personnalisé après (facultatif) -->
';
        $buffer .= $indent . '  <link rel="stylesheet" href="';
        $value = $this->resolveValue($context->find('PUBLIC_ABSOLUTE_PATH'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '      <!-- PARTIAL entete (menu latéral + barre mobile/desktop) -->
';
