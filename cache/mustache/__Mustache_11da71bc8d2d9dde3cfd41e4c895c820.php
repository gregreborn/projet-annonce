...
class __Mustache_11da71bc8d2d9dde3cfd41e4c895c820 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <!-- Google Places API -->
';
        $buffer .= $indent . '  <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&libraries=places&callback=initAutocomplete" async defer></script>
';
        $buffer .= $indent . '    <script src="';
        $value = $this->resolveValue($context->find('PUBLIC_ABSOLUTE_PATH'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
