...
class __Mustache_e7f2ed70cd5680af356dd514c1a67068 extends Mustache_Template
{
...
';
        $buffer .= $indent . '          $(\'.off-canvas-overlay\').hide(); // don\'t show overlay on desktop
';
        $buffer .= $indent . '        } else {
';
...
';
        $buffer .= $indent . '  
';
        $buffer .= $indent . '      // Toggle menu for mobile/tablet
';
...
';
        $buffer .= $indent . '          $(\'.off-canvas-overlay\').toggle(); // only on small screens
';
        $buffer .= $indent . '        }
';
        $buffer .= $indent . '      });
';
        $buffer .= $indent . '  
';
        $buffer .= $indent . '      // Clicking a menu item closes the sidebar (only on small screens)
';
...
';
        $buffer .= $indent . '  
';
        $buffer .= $indent . '      // Clicking overlay closes sidebar (only small screens)
';
