...
class __Mustache_8c387ffc6e296bb5e373fad463991d15 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <!-- Intl-Tel-Input Scripts -->
';
...
';
        $buffer .= $indent . '              alert("❌ Numéro de téléphone invalide.");
';
        $buffer .= $indent . '            } else {
';
        $buffer .= $indent . '              // Format the phone number to E.164 before submission
';
        $buffer .= $indent . '              input.value = iti.getNumber();
';
        $buffer .= $indent . '            }
';
        $buffer .= $indent . '          });
