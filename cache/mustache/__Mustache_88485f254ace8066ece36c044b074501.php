...
class __Mustache_88485f254ace8066ece36c044b074501 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  <script src="https://cdn.jsdelivr.net/npm/pristinejs@latest/dist/pristine.min.js"></script>
';
        $buffer .= $indent . '  <script src="';
        $value = $this->resolveValue($context->find('PUBLIC_ABSOLUTE_PATH'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
