...
class __Mustache_5f5d9bc2d7c2c330397a9a29fcb69226 extends Mustache_Template
{
...
';
        ...
        $value = $this->resolveValue($context->find('PUBLIC_ABSOLUTE_PATH'), $context, $indent);
        $buffer .= htmlspecialchars($value, 2, 'UTF-8');
        $buffer .= '/assets/js/plugins/imageUploader/image_endpoint.php\'
';
        $buffer .= $indent . '        });
';
...
';
        $buffer .= $indent . '          console.log(\'🔔 mediaUploader:uploadComplete reçu\', e.detail);
';
